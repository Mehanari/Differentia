...
using MehaMath.Math.OptimalControlProblems;
...
namespace Src.OptimalControlProblems.PendulumControl
{
    ...
    public class ThrowControlGenerator
    {
            ...
            double time)
        {
            ...
            lambdas = Algorithms.LeastSquaresGradientDescent(objective, lambdas, iterationsLimit: MaxIterations, tolerance: Tolerance, step: 0.1d);
